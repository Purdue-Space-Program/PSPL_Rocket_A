...
print(f"Real Fuel Ullage (with bulkhead taper): {fuel_ullage_volume / fuel_use_volume * 100:.1f} %")
print(f"Real Ox Ullage: (with bulkhead taper): {ox_ullage_volume / ox_use_volume * 100:.1f} %")