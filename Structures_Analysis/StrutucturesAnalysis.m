...
safetyFactorCompression = 1.5; % Honest guess at a safety factor
safetyFactorBuckling = 2.0; % Bending safety factor (ADM ASD)
...
pAllow = (Fcr * area) / safetyFactorBuckling; % Allowable axial load [lb]
...
MoSCompression = (material.yieldCompressionStrength / (compressStress * safetyFactorCompression)) - 1;
MoSTension = ((material.yieldTensionStrength) / (tensileStress * safetyFactorTension)) - 1;
...
%fprintf("Buckling Load MoS: %.2f \n", buckleLimit / (compressStress) - 1)
